...
#define PCD_RESPONSEBUFFER_SIZE		 									CR95HF_MAX_BUFFER_SIZE
...
#define PCD_COMMAND_OFFSET													CR95HF_CONTROL_BYTE_OFFSET
#define PCD_STATUS_OFFSET														CR95HF_CONTROL_BYTE_OFFSET
#define PCD_LENGTH_OFFSET														CR95HF_LENGTH_OFFSET
#define PCD_DATA_OFFSET															CR95HF_DATA_OFFSET
